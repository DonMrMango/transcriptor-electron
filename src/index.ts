import { app, BrowserWindow, ipcMain, clipboard, dialog, globalShortcut, Menu } from 'electron';
...
// Create application menu with update checker
function createApplicationMenu() {
  ...
  const template: any[] = [
    ...
    ...(isMac ? [{
      label: app.name,
      submenu: [
        { role: 'about', label: 'Acerca de Transcriptor' },
        { type: 'separator' },
        {
        ...
        { type: 'separator' },
        { role: 'hide', label: 'Ocultar Transcriptor' },
        { role: 'hideOthers', label: 'Ocultar Otros' },
        { role: 'unhide', label: 'Mostrar Todo' },
        { type: 'separator' },
        { role: 'quit', label: 'Salir de Transcriptor' }
      ]
    }] : []),
    // Help menu
    {
      ...
      submenu: [
        ...
        }] : []),
        {
          ...
          click: async () => {
            ...
            await shell.openExternal('https://github.com/DonMrMango/transcriptor-electron');
          }
        }
      ]
    }
